...
submit:"Create",title:"Crea"},datetime:{amPm:["am","pm"],hours:"Hour",minutes:"Minute",months:"January February March April May June July August September October November December".split(" "),next:"Next",previous:"Previous",seconds:"Second",unknown:"-",weekdays:"Sun Mon Tue Wed Thu Fri Sat".split(" ")},edit:{button:"Edit",submit:"Update",title:"Modifica"},error:{system:'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'},multi:{info:"The selected items contain different values for this input. To edit and set all items for this input to the same value, click or tap here, otherwise they will retain their individual values.",
noMulti:"This input can be edited individually, but not part of a group.",restore:"Cancella le modifiche",title:"Valori multipli"},remove:{button:"Delete",confirm:{1:"Are you sure you wish to delete 1 row?",_:"Are you sure you wish to delete %d rows?"},submit:"Delete",title:"Delete"}},idSrc:"DT_RowId",table:null},vc={action:null,actionName:"action",ajax:null,bubbleNodes:[],closeCb:null,closeIcb:null,dataSource:null,displayController:null,displayed:!1,editCount:0,editData:{},editFields:{},editOpts:{},fields:{},
